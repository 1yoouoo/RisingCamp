        ...
        <div className={scrollPosition < 50 ? "pinning-header" : "moving-header"}>
            <div className="pinning-header-container" style={{top: "0px", position: "relative", background: "transparent"}}>
                ...
                <span className="mainHeaderNfLogo" >
                    ...
                    <div className={buttonOnClick ? "secondary-navigation-searchFocused" : "secondary-navigation"}>
                        {buttonOnClick ? (
                            <div className="nav-element">
                                <div className="searchBox">
                                    ...
                                    <input className="searchInput" placeholder="제목, 사람, 장르" />
                                </div>
                            </div>
                        ) : (
                                <div className="nav-element">
                        ...
                        <div className="nav-element">
                            <div className="account-menu-item">
                                <div className="account-dropdown-button">
                                    <a href="/YourAccount" role="button" tabIndex="0"><span className="profile-link" role="presentation">
                                        <img className="profile-icon" src="https://occ-0-988-395.1.nflxso.net/dnm/api/v6/K6hjPJd6cR6FpVELC5Pd6ovHRSk/AAAABVLoBSVPLWGcJMaF2a-ok9LMApXtKLrdyJh_Oibrfr98pBrWtDUFv0TC5yqWZJk1qsMTFS2aJz5PigbwiW_1HnFmdO-ROIk.png?r=39e" alt=""/>
                                        </span>
                                    </a>
