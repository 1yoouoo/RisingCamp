        ...
        <div id="appMountPoint">
            <div className="login-wrapper hybrid-login-wrapper">
                <div className="login-wrapper-background">
                    <img className="concord-img vlv-creative" src="https://assets.nflxext.com/ffe/siteui/vlv3/79fe83d4-7ef6-4181-9439-46db72599559/296a32a7-870c-4ebe-a49c-0f4223eff344/KR-en-20221017-popsignuptwoweeks-perspective_alpha_website_small.jpg" alt=""/>
                </div>
                <div className="nfHeader login-header signupBasicHeader">
                    <a href="/NetflixHome/index.html" className="svg-nfLogo signupBasicHeader" data-uia="netflix-header-svg-logo">
                        <svg viewBox="0 0 111 30" className="svg-icon svg-icon-netflix-logo" focusable="false" style={{height: "67px" ,"verticalAlign": "middle", width: "167px"}}>
                            <g id="netflix-logo">
                            ...
                            <form method="post" className="login-form">
                                <div className="nfInput nfEmailPhoneInput login-input login-input-email">
                                    <div className="nfInputPlacement">
                                        ...
                                        <div className="inputErrorEmail" style={touched ? (isValidEmail ? {opacity : "0"} : {opacity : "1"}) : {opacity : "0"}}>Please enter a valid email.</div>
                                    </div>
                                </div>
                                ...
                                <div className="hybrid-login-form-help">
                                    <div className="ui-binary-input login-remember-me">
                                        <input type="checkbox" className="rememberMe" id="bxid_rememberMe_true" tabIndex="0" />
                                        <label htmlFor="bxid_rememberMe_true">
                                            
                                            <span className="login-remember-me-label-text">Remember me</span>
                                        </label>
                                    </div>
                                    <a href="/App" className="login-help-link link">Need help?</a>
                                </div>
                            </form>
                        </div>
                            ...
                            <div className="recaptcha-terms-of-use">
                                ...
                                <div className="recaptcha-terms-of-use--disclosure">
                                    <span>The information collected by Google reCAPTCHA is subject to the Google 
                                        <a href="/App" id="recaptcha-privacy-link">Privacy Policy</a>
                                        and
                                        <a href="/App" id="recaptcha-tos-link">Terms of Service</a> 
                ...
                <div className="site-footer-wrapper centered">
                    ...
                    <div className="site-footer">
                        <p className="footer-top">Questions? Call 
                            <a className="footer-top-a" href="tel:080-001-9588">080-001-9588</a>
                        </p>
                        <ul className="footer-links structural">
                            <li className="footer-link-item" placeholder="footer_responsive_link_faq_item">
                                <a className="footer-link" href="/App" placeholder="footer_responsive_link_faq">
                                    <span>FAQ</span>
                                </a>
                            </li>
                            <li className="footer-link-item" placeholder="footer_responsive_link_help_item">
                                <a className="footer-link" href="/App" placeholder="footer_responsive_link_help">
                                    <span>Help Center</span>
                                </a>
                            </li>
                            <li className="footer-link-item" placeholder="footer_responsive_link_terms_item">
                                <a className="footer-link" href="/App" placeholder="footer_responsive_link_terms">
                                    <span>Terms of Use</span>
                                </a>
                            </li>
                            <li className="footer-link-item" placeholder="footer_responsive_link_privacy_separate_link_item">
                                <a className="footer-link" href="/App" placeholder="footer_responsive_link_privacy_separate_link">
                                <span>Privacy</span>
                            </a>
                        </li>
                        <li className="footer-link-item" placeholder="footer_responsive_link_cookies_separate_link_item">
                            <a className="footer-link" href="/App" placeholder="footer_responsive_link_cookies_separate_link">
                                <span>Cookie Preferences</span>
                            </a>
                        </li>
                        <li className="footer-link-item" placeholder="footer_responsive_link_corporate_information_item">
                            <a className="footer-link" href="/App" placeholder="footer_responsive_link_corporate_information">
                    ...
                    <div className="lang-selection-container" id="lang-switcher">
                        <div className="ui-select-wrapper">
                            ...
                            <div className="select-arrow medium prefix globe">
                                <select className="ui-select medium" id="lang-switcher-select" tabIndex="0" placeholder="lang-switcher">
                                    <option>한국어</option>
                    ...
                    <div className="copy-text">
                        ...
                        <div className="copy-text-block">Address: 20F, Tower A, Centropolis Building 26, Ujeongguk-ro, Jongno-gu, Seoul, 03161 Republic of Korea</div>
                        <div className="copy-text-block">Business registration number: 165-87-00119</div>
                        <div className="copy-text-block">Hosted by: Amazon Web Services Inc.</div>
                        <div className="copy-text-block">
                            <a href="http://www.ftc.go.kr/bizCommPop.do?wrkr_no=1658700119">KFTC website</a>
                        </div>
                    </div>
                </div>
                </div>
