            ...
            <div className="login-wrapper hybrid-login-wrapper">
                ...
                <div className="nfHeader login-header signupBasicHeader">
                    <a href="/NetflixHome/index.html" className="svg-nfLogo signupBasicHeader" data-uia="netflix-header-svg-logo">
                        <svg viewBox="0 0 111 30" className="svg-icon svg-icon-netflix-logo" focusable="false" style={{height: "67px" ,"vertical-align": "middle", width: "167px"}}>
                            <g id="netflix-logo">
                                ...
                                <div className="nfInput nfPasswordInput login-input login-input-password">
                                    <div className="nfInputPlacement">
                                        <div className="nfPasswordControls">
                                            <label className="input_id">
                                                <input type="password" className="nfTextField" id="id_password" tabIndex="0" autoComplete="password" />
