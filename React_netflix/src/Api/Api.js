const fifteen = {
  ...
  number:
    "M36.876 15.482v68.651H21.509v-49.51h-5.484l7.097-19.141h13.754zm45.46 0V28.87H57.175v10.063h24.08c.845 0 1.533.687 1.533 1.534v42.13c0 .845-.688 1.532-1.534 1.532H43.616a1.533 1.533 0 01-1.533-1.533V62.202H57v8.988h10.874V52.052h-25.79v-36.57h40.254z",
};
const eighteen = {
  fill: "#C52E37",
  background:
...
const API = {
  ...
  getArt: (artId) => {
    ...
    return {
      ...
      videoQuality: "HD",
      artSummary:
        "천재적인 두뇌의 소유자 우영우. 대형 로펌의 신입 변호사이자 자폐 스펙트럼 장애를 가진 여성으로서 법정 안팎에서 다양한 난관을 해쳐간다.",
      ...
      episodeList: [
        ...
        },
        {
          ...
          episodeSummary:
            "영우에게 법적 조언을 구하는 친구 동그라미. 아버지가 본의 아니게 어마어마한 빚을 졌다는게 사연인데. 한편 민우는 부당함에 분노한다.",
          episodeDuration: "69",
        },
        {
          episodeId: 10105,
          ...
          episodeSummary:
            "두 ATM 회사가 저작권을 두고 소송 싸움을 시작했다. 덕분에 사건을 맡은 영우와 민우도 치열한 경쟁을 벌이고. 그라미는 영우에게 상대의 거짓말을 알아채는 법을 가르쳐준다.",
          episodeDuration: "69",
        },
      ],
    };
